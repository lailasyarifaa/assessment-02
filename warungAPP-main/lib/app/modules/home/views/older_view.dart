...
class OlderView extends StatelessWidget {
  ...
  Widget _buildPaymentOption(String title, IconData icon) {
    return InkWell(
      onTap: () {
        // Tambahkan aksi saat opsi pembayaran diklik
      },
      child: Container(
        padding: EdgeInsets.all(12.0),
        decoration: BoxDecoration(
          color: AppColors.cardBackground, // Sesuaikan dengan warna latar belakang
          borderRadius: BorderRadius.circular(8),
          boxShadow: [
            BoxShadow(
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                Icon(icon, color: AppColors.iconColor), // Ikon metode pembayaran
                SizedBox(width: 8),
                Text(
                  title,
                  style: TextStyle(
            ...
            Icon(Icons.chevron_right, color: AppColors.iconColor), // Ikon panah untuk navigasi
          ],
        ),
      ),
    );
